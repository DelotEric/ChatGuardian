                    ...
                    <tbody>
                        @forelse($volunteers as $volunteer)
                            <tr>
                                ...
                                <a href="{{ route('volunteers.show', $volunteer) }}" class="text-decoration-none text-dark">
                                    {{ $volunteer->full_name }}
                                </a>
                            </td>
                                ...
                                <td>
                                    <span
                                        class="badge {{ $volunteer->is_active ? 'bg-soft-success text-success' : 'bg-soft-secondary text-muted' }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="availability" type="text" class="form-control"
                                    placeholder="Soirs, week-ends...">
                            </div>
                            <div class="col-12">
                                <label class="form-label">Compétences</label>
                                <textarea name="skills" class="form-control" rows="2"
                                    placeholder="Captures, soins, transport..."></textarea>
                            </div>
