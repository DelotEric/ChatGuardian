...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('donors.index') }}" class="btn btn-outline-primary">Gérer les donateurs</a>
                        ...
                        @forelse($donations as $donation)
                            <tr>
                                <td class="fw-semibold">
                                    <a href="{{ route('donations.show', $donation) }}" class="text-decoration-none text-dark">
                                        {{ $donation->donor->name }}
                                    </a>
                                </td>
