            ...
            <form class="row g-3" method="POST" action="{{ route('feeding-points.store') }}">
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" class="form-control" rows="2"
                        placeholder="Repères, fréquence de nourrissage..."></textarea>
                </div>
                <div class="col-12">
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h5 class="mb-1">
                                    <a href="{{ route('feeding-points.show', $point) }}" class="text-decoration-none text-dark">
                                        {{ $point->name }}
                                    </a>
                                </h5>
                            ...
                            <div class="d-flex flex-column align-items-end gap-2">
                                <span class="badge bg-soft-primary text-primary">{{ $point->volunteers->count() }}
                                    bénévole(s)</span>
                                <div class="d-flex gap-2">
                                    <a href="{{ route('feeding-points.edit', $point) }}" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('feeding-points.destroy', $point) }}" method="POST"
