...
@section('content')
    <div class="container py-4">
        <h1 class="h3 mb-4"><i class="bi bi-calendar-event"></i> Modifier l'événement</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                <option value="adoption_day" {{ old('type', $event->type) == 'adoption_day' ? 'selected' : '' }}>Journée d'adoption</option>
                                <option value="training" {{ old('type', $event->type) == 'training' ? 'selected' : '' }}>
                                    Formation</option>
                                <option value="meeting" {{ old('type', $event->type) == 'meeting' ? 'selected' : '' }}>Réunion
                                </option>
                                <option value="other" {{ old('type', $event->type) == 'other' ? 'selected' : '' }}>Autre
                                </option>
                            </select>
